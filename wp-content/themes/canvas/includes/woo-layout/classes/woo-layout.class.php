...
class Woo_Layout {
	...
	function enqueue_frontend_styles () {
		...
		wp_register_style( 'woo-layout-dynamic', urldecode( $url . $sep . 'woo-layout-css=load' ) );
	...
	function get_layout_info () {
		...
		if ( is_array( $woo_layouts ) && is_array( $woo_options ) ) {
			...
			$data['width_main'] = ceil( ( $data['one_percent'] * $woo_layouts['layouts'][$layout]['content'] ) - $data['gutter'] );
			$data['width_primary'] = ceil( ( $data['one_percent'] * $woo_layouts['layouts'][$layout]['primary'] ) - $data['gutter'] );
			$data['width_secondary'] = ceil( ( $data['one_percent'] * @$woo_layouts['layouts'][$layout]['secondary'] ) - $data['gutter'] );
	...
	function load_dynamic_css () {
		...
		if ( isset( $_GET['woo-layout-css'] ) && $_GET['woo-layout-css'] == 'load' ) {
			...
			if ( $width_maincontainer ) { $css .= '.' . $layout . $container_class . ' #main-sidebar-container { width: ' . $width_maincontainer . 'px' . '; }' . "\n"; }
			if ( $width_main ) { $css .= '.' . $layout . $container_class . ' #main-sidebar-container #main { width: ' . $width_main . 'px' . '; }' . "\n"; }
			if ( $width_primary ) { $css .= '.' . $layout . $container_class . ' #main-sidebar-container #sidebar { width: ' . $width_primary . 'px' . '; }' . "\n"; }
			if ( $width_secondary ) { $css .= '.' . $layout . $container_class . ' #sidebar-alt { width: ' . $width_secondary . 'px' . '; }' . "\n"; }
			
//			$css .= "\n" . '/* Business Page Template */' . "\n";
			
/*
			if ( $width_main ) { $css .= '.' . $layout . $container_class . ' .business #main-sidebar-container { width: ' . $container_width . 'px' . '; }' . "\n"; }
			if ( $width_secondary ) { $css .= '.' . $layout . $container_class . ' .business #main-sidebar-container #main { margin-left: ' . $width_secondary . 'px; }' . "\n"; }
			
			if ( $width_secondary ) { $css .= '.' . $layout . $container_class . ' .business #sidebar-alt { position: relative; }' . "\n"; }
*/

			$css .= "\n" . '/* Magazine Page Template */' . "\n";
			
			if ( $width_main ) { $css .= '.' . $layout . $container_class . ' .magazine #loopedSlider { width: ' . ( $width_main ) . 'px' . '; }' . "\n"; }
			
			if ( $width_main ) { $css .= '.' . $layout . $container_class . ' .magazine #loopedSlider .container { width: ' . ( $width_main ) . 'px' . '; }' . "\n"; }
