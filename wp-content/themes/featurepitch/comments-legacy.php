...
<p class="alert"><?php _e('You must be', 'woothemes' ); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>" rel="nofollow"><?php _e('logged in', 'woothemes' ); ?></a> <?php _e('to post a comment.', 'woothemes' ); ?></p>
<?php else : ?>
