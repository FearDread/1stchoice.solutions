<?php get_header(); ?>
	...
	<div id="main" class="col-left">  
	    <input type="hidden" value="<?php printf(the_search_query()); ?>" id="searchvalue" />
		<span id="currentpost">0</span>
		...
		<?php if (get_option('woo_ajax_search_pagination') == 'true') { woo_ajax_load_more();
        } else { woo_pagenav(); } ?>
