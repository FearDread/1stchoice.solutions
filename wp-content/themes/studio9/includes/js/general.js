...
//twitter
   jQuery('.twitter-close').click(function(){
      ...
      jQuery('.twitter-open').show(500);
   });
   jQuery('.twitter-open span').click(function(){
      jQuery('.twitter-open').hide(500);
      jQuery('.twitter-close').show(500);
   });
...
//share
   jQuery('.share-post-button').click(function(){
...
//inputs auto fill
 ...
 //overview
         jQuery('.over').hover(function(){
            jQuery(this).children('.overview').css('visibility','visible');
         },function(){
            jQuery(this).children('.overview').css('visibility','hidden');
         });
         jQuery('.over-hex').hover(function(){
            jQuery(this).children('.overview').css('visibility','visible');
            jQuery(this).children('.over-content').css('visibility','visible');
         },function(){
            jQuery(this).children('.overview').css('visibility','hidden');
            jQuery(this).children('.over-content').css('visibility','hidden');
         });
   //simplemodal
   jQuery('.modal').click(function (e) {
      jQuery('.modal').next('div').modal();
      return false;
   });
   //jcarousel
