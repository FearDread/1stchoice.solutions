...
$default_google_fonts = array( 'Istok Web', 'Droid Sans' );
		...
		if ( is_array($woo_options) ) {
			...
			if ( isset( $woo_options['woo_typography'] ) && $woo_options['woo_typography'] == 'true' ) {
				...
				if ( isset( $woo_options['woo_font_nav'] ) && $woo_options['woo_font_nav'] )
					$output .= '#navigation ul.nav > li a { '.woo_generate_font_css($woo_options['woo_font_nav'], '1.618').' }' . "\n";	
			
				if ( isset( $woo_options['woo_font_page_title'] ) && $woo_options['woo_font_page_title'] )
					$output .= '.page header h1 { '.woo_generate_font_css($woo_options[ 'woo_font_page_title' ], '1.387').' }' . "\n";
			
				if ( isset( $woo_options['woo_font_post_title'] ) && $woo_options['woo_font_post_title'] )
					$output .= '.post header h1 { '.woo_generate_font_css($woo_options[ 'woo_font_post_title' ], '1.387').' }' . "\n";	
			
				if ( isset( $woo_options['woo_font_post_meta'] ) && $woo_options['woo_font_post_meta'] )
					$output .= '.post .post-meta li, .post .post-meta li a, .post .post-meta li.post-date { '.woo_generate_font_css($woo_options[ 'woo_font_post_meta' ], '1.7').' }' . "\n";	
...
if ( ! function_exists( 'woo_layout_body_class' ) ) {
	function woo_layout_body_class( $classes ) {
		...
		// Slideshow pagination-related classes.
		if ( isset( $woo_options['woo_featured_pagination'] ) && ( 'true' == $woo_options['woo_featured_pagination'] ) ) {
			$classes[] = 'has-slider-pagination';

			if ( isset( $woo_options['woo_featured_pagination_vertical'] ) && ( 'true' == $woo_options['woo_featured_pagination_vertical'] ) ) {
				$classes[] = 'has-vertical-slider-pagination';
			} else {
				$classes[] = 'has-horizontal-slider-pagination';
			}
		}
