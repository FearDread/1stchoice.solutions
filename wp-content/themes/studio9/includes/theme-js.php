...
if ( ! function_exists( 'woothemes_add_javascript' ) ) {
	function woothemes_add_javascript() {
		...
		wp_enqueue_script( 'roundabout', get_template_directory_uri() . '/includes/js/jquery.roundabout.min.js', array( 'jquery' ) );
		wp_enqueue_script( 'simplemodal', get_template_directory_uri() . '/includes/js/jquery.simplemodal.js', array( 'jquery' ) );
