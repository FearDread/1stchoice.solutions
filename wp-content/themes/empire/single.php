    ...
    <div id="content" class="col-full">
        ...
        <?php while (have_posts()) : the_post(); $count++; ?>
			...
			<div <?php post_class(); ?>>
                ...
                <?php if ( isset($woo_options[ 'woo_thumb_single' ]) && $woo_options[ 'woo_thumb_single' ] == "true" && !woo_embed( '')) woo_image( 'width='.$woo_options[ 'woo_single_w' ].'&height='.$woo_options[ 'woo_single_h' ].'&class=thumbnail '.$woo_options[ 'woo_thumb_single_align' ]); ?>
