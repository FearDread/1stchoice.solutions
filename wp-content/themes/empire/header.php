 		...
 		<div class="col-full">
			...
			<?php if ( isset($woo_options['woo_texttitle']) && $woo_options['woo_texttitle'] != 'true' ) { $logo = $woo_options['woo_logo']; ?>
				<a href="<?php echo home_url( '/' ); ?>" title="<?php bloginfo( 'description' ); ?>">
					<img src="<?php if (isset($logo) && $logo != '') { echo $logo; } else { echo get_template_directory_uri(); ?>/images/logo.png<?php } ?>" alt="<?php bloginfo( 'name' ); ?>" />
				</a>
	        <?php } else { ?>
	        	<a href="<?php echo home_url( '/' ); ?>" title="<?php bloginfo( 'description' ); ?>">
	        ...
	        <div id="header-right">
	        	...
	        	<div class="fl">
	        		<?php if ( $woo_options[ 'woo_header_right_text' ] != '' ) { ?><p><?php echo stripslashes( $woo_options[ 'woo_header_right_text' ] ); ?></p><?php } ?>
	        	</div><!-- /.fl -->
	        	<?php } ?>
	        	
	        	<?php if ( $woo_options[ 'woo_header_right_btn' ] == 'true' ) { ?>
	        	<div class="fr">
	        		<a href="<?php echo $woo_options[ 'woo_header_right_btn_link' ]; ?>"><span><?php echo stripslashes( $woo_options[ 'woo_header_right_btn_text' ] ); ?></span></a>
	        	</div><!-- /.fr -->
	        	<?php } ?>
