...
if (!function_exists( 'the_widgets_init')) {
	function the_widgets_init() {
		...
		register_sidebar(array( 'name' => 'Home Left','id' => 'home-left','description' => "Home Left", 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '<span class="arrow"></span></h3>'));  
		register_sidebar(array( 'name' => 'Home Center','id' => 'home-center','description' => "Home Center", 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '<span class="arrow"></span></h3>'));  		
		register_sidebar(array( 'name' => 'Home Right','id' => 'home-right','description' => "Home Right", 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '<span class="arrow"></span></h3>'));   
