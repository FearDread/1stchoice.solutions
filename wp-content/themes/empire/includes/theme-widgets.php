...
include( get_template_directory() . '/includes/widgets/widget-woo-getintouch.php' );
include( get_template_directory() . '/includes/widgets/widget-woo-feedback.php' );
include( get_template_directory() . '/includes/widgets/widget-woo-archives.php' );
include( get_template_directory() . '/includes/widgets/widget-woo-contact-us.php' );
