...
class Woo_BlogAuthorInfo extends WP_Widget {
   ...
   function form($instance) {        
		...
		<p>
		   ...
		   <input type="text" name="<?php echo $this->get_field_name( 'custom_email' ); ?>"  value="<?php esc_attr_e( $custom_email ); ?>" class="widefat" id="<?php echo $this->get_field_id( 'custom_email' ); ?>" />
		</p>
		<p>
