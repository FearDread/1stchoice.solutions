            ...
            <?php while ( have_posts() ) : the_post(); $count++; ?>
				...
				<div <?php post_class(); ?> id="striped">
					...
					<span class="post-nav fr">
						<span class="prev"><?php previous_post_link( '%link', __( 'Previous', 'woothemes' ) ); ?></span>
						<span class="next"><?php next_post_link( '%link', __( 'Next', 'woothemes' ) ); ?></span>
			       	</span>
					</h3>
	                ...
	                <div class="entry" id="plate">
						...
						<?php if ( isset( $woo_options['woo_thumb_single'] ) && $woo_options['woo_thumb_single'] == "true" && !woo_get_embed( 'embed', '580', '420' ) ) woo_image( 'width='.$woo_options['woo_single_w'].'&height='.$woo_options['woo_single_h'].'&class=thumbnail '.$woo_options['woo_thumb_single_align'] ); ?>
