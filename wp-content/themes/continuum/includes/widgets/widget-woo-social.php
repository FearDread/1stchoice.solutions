...
class WP_Widget_Social extends WP_Widget {
	...
	function WP_Widget_Social() {
		$widget_ops = array( 'classname' => 'widget_social', 'description' => __( 'Add social links in your sidebar', 'woothemes' ) );
		$this->WP_Widget( 'woo_social', __( 'Woo - Social', 'woothemes' ), $widget_ops );
	}
...
?>
		...
		<p><label for="<?php echo $this->get_field_id( 'facebook' ); ?>"><?php _e( 'Facebook URL:', 'woothemes' ); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'twitter' ); ?>"><?php _e( 'Twitter URL:', 'woothemes' ); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'flickr' ); ?>"><?php _e( 'Flickr URL:', 'woothemes' ); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'youtube' ); ?>"><?php _e( 'YouTube URL:', 'woothemes' ); ?></label>
