...
class woo_CampaignMonitorWidget extends WP_Widget {
	function woo_CampaignMonitorWidget() {
		$widget_ops = array( 'classname' => 'widget_campaign_monitor', 'description' => __( 'Add a Campaign Monitor subscription form', 'woothemes' ) );
		$this->WP_Widget( 'campaign_monitor', __( 'Woo - Campaign Monitor', 'woothemes' ), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		echo '<div><form name="campaignmonitorform" id="campaignmonitorform" action="'.$action.'" method="post">';
		...
		echo '<input id="newsletter-submit" class="button" type="submit" name="submit" value="Submit &raquo;" />';
		echo '</form></div>';
		echo $after_widget;
	}
...
?>
			...
			<p><label for="<?php echo $this->get_field_id( 'action' ); ?>"><?php _e( 'Form Action:', 'woothemes' ); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'action' ); ?>" name="<?php echo $this->get_field_name( 'action' ); ?>" type="text" value="<?php echo esc_attr( $action ); ?>" /></label></p>
			<p><label for="<?php echo $this->get_field_id( 'id' ); ?>"><?php _e( 'Campaign Monitor ID:', 'woothemes' ); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'id' ); ?>" name="<?php echo $this->get_field_name( 'id' ); ?>" type="text" value="<?php echo esc_attr( $id ); ?>" /></label></p>
<?php
	}
}
