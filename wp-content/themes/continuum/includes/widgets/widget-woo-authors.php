...
class WP_Widget_Authors extends WP_Widget {
	...
	function WP_Widget_Authors() {
		$widget_ops = array( 'classname' => 'widget_authors', 'description' => __( 'Authors Widget', 'woothemes' ) );
		//$control_ops = array('width' => 400, 'height' => 350);
		$this->WP_Widget( 'woo_authors', __( 'Woo - Authors', 'woothemes' ), $widget_ops /*,$control_ops*/ );
	}
...
?>
		...
		<p><label for="<?php echo $this->get_field_id( 'level' ); ?>"><?php _e( 'User level to show:', 'woothemes' ); ?></label>
		<select class="widefat" id="<?php echo $this->get_field_id( 'level' ); ?>" name="<?php echo $this->get_field_name( 'level' ); ?>">
			<?php
		$array = array(
			'a'=> __( 'Admins, Editors, Authors, Contributors', 'woothemes' ),
			'b'=> __( 'Just Admins', 'woothemes' ),
			'c'=> __( 'Just Editors', 'woothemes' ),
			'd'=> __( 'Just Authors', 'woothemes' ),
			'e'=> __( 'Just Contributors', 'woothemes' )
		);
