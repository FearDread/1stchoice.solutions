...
<div id="loopedSlider">
	<div class="plate">
    <?php $woo_slider_tags = ''; if ( isset( $woo_options['woo_slider_tags'] ) ) { $woo_slider_tags = $woo_options['woo_slider_tags']; } if ( ( $woo_slider_tags != '' ) && ( isset( $woo_slider_tags ) ) ) { ?>
    <?php
	unset( $tag_array );
...
?>
    ...
    <div class="container">
		...
		<?php if ( $count > 1 ) : ?>
<a href="#" class="next"><img src="<?php echo get_template_directory_uri(); ?>/images/btn-slider-next.png" alt="&gt;" /></a>
            <a href="#" class="previous"><img src="<?php echo get_template_directory_uri(); ?>/images/btn-slider-prev.png" alt="&lt;" /></a>
        <?php endif; ?>
...
?>
        play: <?php echo $autoStart; ?>,
        slideSpeed: <?php echo $slidespeed; ?>, 
        fadeSpeed: <?php echo $slidespeed; ?>, 
        autoHeight: true, 
        container: 'slides', 
        next: 'next', 
        prev: 'previous', 
