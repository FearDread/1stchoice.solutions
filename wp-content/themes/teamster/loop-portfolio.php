...
// Handles Click through from Authors page
if ( isset($_GET['authorid']) && ( $_GET['authorid'] > 0 ) && ( is_post_type_archive('portfolio') ) ) {
	$author_id = (int) $_GET['authorid'];
...
?>
		...
		?>
			...
			<span class="author"><?php echo __( 'by', 'woothemes' ) . ' '; the_author_posts_link(); ?></span>
