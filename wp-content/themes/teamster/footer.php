<?php global $woo_options; ?>
	...
	<div id="footer-widgets" class="col-full col-<?php echo $total; ?>">
		...
		<div class="block <?php if ( $total == 3 && $i==3 ) echo 'special'; ?> footer-widget-<?php echo $i; ?>">
